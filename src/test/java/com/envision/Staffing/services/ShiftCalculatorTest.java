...
public class ShiftCalculatorTest {
	...
	public void testCalculatePhysicianSlotsForAll() throws Throwable {
		...
		shiftCalculator.calculatePhysicianSlotsForAll(22, 4, shiftLength, clinicians, lowerLimitFactor, "utilization", 2 , 4, null);
		Assert.assertEquals(0, clinicians[0].getClinicianCountPerHour()[0], 0);

		shiftCalculator.calculatePhysicianSlotsForAll(1, 6, shiftLength, clinicians, lowerLimitFactor,null, 2 , 4, null);
	...
	public void testCheckAndAddClinicianForAllShift() throws Throwable {
		...
		workload.setSizeOfArray(12);
		shiftCalculator.setWorkloads(workload);
		result = shiftCalculator.CheckAndAddClinicianForAllShift(2 , 4, shiftLength, clinicians, start, lowerLimitFactor, "utilization",2,4, null);
		Assert.assertEquals(1, result, 0);
	}
